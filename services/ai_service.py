...
5. 回答策略：
   - 有外部数据 → 基于数据回答，引用具体数字，confidence_score 70-90
   - 无外部数据但有相关知识 → 提供分析，不编造数字，confidence_score 50
   - 完全不确定 → 诚实说不太确定，confidence_score 50
   - 绝不设置 confidence_score < 50

━━━━━━━━━━━━━━━━━━━━━━
输出格式 (JSON) — confidence_score 必须是 50 到 90 之间的数字:
{"question":"用户问题","verified_data":["引用来源"],"analysis":"中文分析","confidence_score":50,"sources":["来源名称"]}"""
